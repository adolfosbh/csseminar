...
public class CSSeminarsSyntacticSequencer extends AbstractSyntacticSequencer {

	protected CSSeminarsGrammarAccess grammarAccess;
	
	@Inject
	protected void init(IGrammarAccess access) {
		grammarAccess = (CSSeminarsGrammarAccess) access;
	}
